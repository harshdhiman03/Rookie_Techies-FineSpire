        ...
        <div className="min-h-screen">
            <header className="w-11/12 mx-auto flex justify-between mt-4 items-center">
                ...
                <div className="bg-[#1D1D41] flex justify-between w-8/12 p-2 rounded-2xl items-center">
                    ...
                    <p onClick={() => { handleOnClick(); }} className="text-white text-xl cursor-pointer"><FaSearch /></p>
                </div>
            </header>
            {/* <App prop={APIData} /> */}
            <div className="w-11/12 mx-auto flex flex-wrap mt-[25px]">
                <div className="w-full">
                    <h2 className="text-white text-xl mb-[20px]">Watchlist</h2>
                    <div className="w-full h-[400px] min-w-[300px] min-h-[400px]">
                        <MarketWidget />
                    </div>
                </div>
                <div className="w-full justify-between items-center flex flex-wrap mb-[50px]">
                    <div className="min-[1200px]:max-w-[400px] w-full">
                        <h2 className="text-white text-xl my-[20px]">Stock Specific Chart</h2>
                        <div className="w-full h-[400px] min-w-[300px] min-h-[400px]">
                            <AdvanceChart stock={stock} />
                        </div>
                    </div>
                    <div className="min-[1200px]:max-w-[400px] max-w-[400px] w-full">
                        <h2 className="text-white text-xl my-[20px]">Upcoming Events</h2>
                        <div className="w-full h-[400px] min-w-[300px] min-h-[400px]">
                            <Calender />
                        </div>
                    </div>
